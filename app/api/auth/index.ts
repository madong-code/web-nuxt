 ...
 * 微信授权登录
 */
export function authenticateWithWechat(data: any): Promise<any> {
 ...
 * 微信小程序登录
 */
export function authenticateWithWeapp(data: any): Promise<any> {
 ...
 * 生成微信扫码登录二维码
 */
export function generateWechatQrCode(): Promise<any> {
 ...
 * 检查微信扫码状态
 */
export function checkWechatScanStatus(data: { scene_id: string }): Promise<any> {
 ...
 * 获取第三方绑定列表
 */
export function getThirdPartyList(): Promise<any[]> {
 ...
 * 生成第三方绑定二维码
 */
export function generateBindQrCode(platform: number): Promise<any> {
 ...
 * 检查绑定二维码状态
 */
export function checkBindQrStatus(sceneId: string): Promise<any> {
